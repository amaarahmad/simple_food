...
class KidneyCleanseScreen extends StatefulWidget {
  const KidneyCleanseScreen({Key? key}) : super(key: key);

  @override
  State<KidneyCleanseScreen> createState() => _KidneyCleanseScreenState();
}

class _KidneyCleanseScreenState extends State<KidneyCleanseScreen> {
  @override
                   ...
                   child: Column(
                     ...
                     children: [
                       ...
                       Row(
                         mainAxisAlignment: MainAxisAlignment.spaceAround,
                         children: [
                           Text('Kidney Cleanse',style: TextStyle(fontSize: 30),),
                           Image.asset(AppAssets.kid,)
                         ],
                       ),
                       SizedBox(
                         height: 35,
                       ...
                       Container(
                         ...
                         child: Image.asset(AppAssets.bottle,alignment: Alignment.bottomCenter),
                       ),
                       Row(
                         mainAxisAlignment: MainAxisAlignment.center,
                         children: [
                           Text("Rs69.99",style: TextStyle(fontSize: 30),),
                           SizedBox(
                             width: 10,
                           ),
                           Container(
